...
namespace QDspx {
    ...
    // 音轨主控
    struct QDSPX_EXPORT TrackControl : public Control {
        double pan;
        bool solo;
    ...
    // 控制点
    struct QDSPX_EXPORT AnchorPoint : public IntPoint {
        enum Interpolation {
            __qas_attr__("none")    //
            None,
            __qas_attr__("linear")  //
