...
class QMEDITING_EXPORT AceTreeSerializer {
public:
    ...
    struct ArrayOptions {
        ...
        Result (*creator)(AceTreeItem *, void *);
        Result (*restorer)(AceTreeItem *, void *);
    };
...
public:
    ...
    QString arrayTypeFiled() const;
    bool isArrayUnordered() const;
    void setArrayOptions(const ArrayOptions &opt);
    void setArrayUnordered(bool on);
...
public:
    ...
    virtual void restoreValue(AceTreeItem *item);
    virtual void restoreArray(AceTreeItem *item);
    virtual void restoreObject(AceTreeItem *item);

public:
    virtual AceTreeItem *createChildItem(AceTreeSerializer *child, AceTreeItem *item);
    virtual bool addChildItem(AceTreeItem *childItem, AceTreeItem *item);
