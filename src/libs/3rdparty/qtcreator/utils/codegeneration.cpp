                           ...
                           QTextStream &str)
{
    ...
    QSet<QString> qt4Only = QSet<QString>(qt4.begin(), qt4.end()); //Utils::transform<QSet>(qt4, trans);
    QSet<QString> qt5Only = QSet<QString>(qt5.begin(), qt5.end()); //Utils::transform<QSet>(qt5, trans);
