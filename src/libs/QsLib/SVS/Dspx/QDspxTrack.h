...
namespace QDspx {
    ...
    // 波形区间
    struct QDSPX_EXPORT AudioClip : public Clip {
        QString path;
    ...
    // 人声区间
    struct QDSPX_EXPORT SingingClip : public Clip {
        QList<Note> notes;
        SingleParam params;
