...
class QUTACORE_API ResamplerArgs {
public:
    ResamplerArgs();
    ~ResamplerArgs();
    void clear();
    ...
    QOtoItem genonSettings() const;
    void setGenonSettings(const QOtoItem &genonSettings);

    QOtoItemBrief correctGenon() const;
    void setCorrectGenon(const QOtoItemBrief &correctGenon);
...
private:
    ...
    QOtoItem m_genonSettings;
    QOtoItemBrief m_correctGenon;
