...
using namespace BatProc::Internal;

JsInternalObject::JsInternalObject(QJSEngine *engine, BatProcAddOn *addOn): JsInternalObject(new JsInternalObjectPrivate(engine, addOn)) {}
...
JsInternalObjectPrivate::JsInternalObjectPrivate(QJSEngine *engine, BatProcAddOn *addOn): engine(engine), addOn(addOn) {}
